...
if(isset($_POST["get_seleted_Category"]) || isset($_POST["selectBrand"]) || isset($_POST["search"])){
	if(isset($_POST["get_seleted_Category"])){
		$id = $_POST["cat_id"];
		$sql = "SELECT * FROM products p,categories c WHERE p.product_cat = '$id' AND p.product_cat=c.cat_id";
	...
	if (isset($_POST["getCartItem"])) {
		...
		if (mysqli_num_rows($query) > 0) {
				...
				echo '
                    ...
                    <div class="product-widget">
												...
												<div class="product-body">
													...
													<h4 class="product-price"><span class="qty">'.$n.'</span><i class="fa fa-inr" aria-hidden="true"></i> '.$product_price.'</h4>
												</div>
            ...
            echo '<div class="cart-summary">
				    ...
				    <h5><i class="fa fa-inr" aria-hidden="true"> </i>' .$total_price.'</h5>
				</div>'
            ?>
			...
			<form method="post" action="login_form.php">
					...
					echo 
						...
						<tr>
							...
							<div class="btn-group">
								...
								<a href="#" class="btn btn-danger btn-sm remove" remove_id="'.$product_id.'"><i class="fa fa-trash-o"> Remove</i></a>		
							</div>							
							</td>
						</tr>
				...
				<tfoot>
					...
					<tr>
						...
						<td class="-xs text-center"><b class="net_total " ></b></td>
						...
						<form action="checkout.php" method="post">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/myfiles/public_html/payment_success.php"/>
									...
									<input type="hidden" name="currency_code" value="INDIA"/>

...
<section class="section">       
	<div class="container-fluid">
		...
		echo'
			<div class="col-75" >
				<div class="container-checkout form-style-5">
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<input type="text" id="fname" class="" name="firstname" pattern="^[a-zA-Z ]+$"  value="'.$row["first_name"].' '.$row["last_name"].'">
						<label for="email"><i class="fa fa-envelope"></i> Email</label>
						<input type="text" id="email" name="email" class="f" pattern="^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9]+(\.[a-z]{2,4})$" value="'.$row["email"].'" required>
						<label for="adr"><i class="fa fa-address-card-o"></i> Address</label>
						<input type="text" id="adr" name="address" class="ontrol" value="'.$row["address1"].'" required>
		...
		?>
			...
			<div class="col-25" >
								<div class="container-checkout" style="left:25cm;position:absolute;">
				...
				<h3>total<span class='price' style='color:black'><b><i class='fa fa-rupee ' ></i>&nbsp;$total</b></span></h3>";

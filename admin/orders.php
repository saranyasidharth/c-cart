...
?>
      <!-- End Navbar -->
      <div class="content" style="top:1cm;left:.5cm;position:relative">
                      ...
                      <?php 
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <!-- <p><b>Contact  :</b><?php echo $row['mobile'] ?></p> -->
                          </td>
                          <td>
                            <?php if($row['status'] == 0): ?>
                              <div class="badge badge-danger">Cancelled</div>
                               <?php elseif($row['status'] == 1): ?>
                              <div class="badge " style="font-size:15px;">Pending</div>
                              <?php elseif($row['status'] == 2): ?>
                              <div class="badge" style="font-size:15px;">Shipped</div>
                              <?php elseif($row['status'] == 3): ?>
                              <div class="badge " style="font-size:15px;">Delivered</div>
                              <?php endif; ?>
                          ...
                          <td>
                               ...
                               <?php if($row['status'] == 1): ?>
                                <button class="btn btn-md btn-info changestatus" data-stat ='2' data-id="<?php echo $row['order_id'] ?>">Mark as Shipped</button>
                              <?php elseif($row['status'] == 2): ?>
                                <button class="btn btn-md btn-info changestatus" data-stat ='3' data-id="<?php echo $row['order_id'] ?>">Mark as Delivered</button>
                              <?php elseif($row['status'] == 3): ?>
                                <h5><div class="badge badge-pill badge-success lg " style=:padding:4px; data-id="<?php echo $row['order_id'] ?>" disabled>Delivered</div>
                             </h5> <?php endif; ?>
                          </td>
                        </tr>
                        <?php

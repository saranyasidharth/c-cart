...
?>
      <!-- End Navbar -->
      <div class="content" style="top:1cm;position:relative;">
        ...
        <div class="col-lg-12">
         ...
         <div class="col-md-6">
            <div class="card">
              ...
              <div class="card-body">
                <div class="col-md-8 offset-md-8"> <a class=" btn btn-primary " href="javascript:void(0)" id="newcat">Add New  <i class="fa fa-plus-circle" aria-hidden="true"></i></a></div> 
                <br>
                  ...
                  <table class="table table-striped " id="brand">
                    ...
                    <tbody>
                      <?php 
                        ...
                        <td>$cat_title</td>
                        <td>
                        <a class=' btn btn-success btn-sm edit_cat' href='javascript:void(0)' data-id ='$cat_id'>Edit</a>
          ...
          <div class="col-md-6">
            <div class="card">
              ...
              <div class="card-body">
                <div class="col-md-8 offset-md-8"> <a class=" btn btn-primary " href="javascript:void(0)" id="newbrand">Add New &nbsp;<i class="fa fa-plus-circle" aria-hidden="true"></i></a></div> 
                <br>
                <div class="table-responsive ps">
                  <table class="table table-striped " id="cat">
                    ...
                    <tbody>
                      <?php 
                        ...
                        <td>$brand_title</td>
                        <td>
                        <a class=' btn btn-success btn-sm edit_brand' href='javascript:void(0)' data-id ='$brand_id'>Edit</a>
  		...
  		<div class="modal-dialog ">
      		<div class="modal-content">
      			...
      			<div class="modal-footer">
      				 <button type="button" class="btn btn-success" id='submit' onclick="$('#catmodal form').submit()">Save</button>
      ...
      <div class="modal fade" id="brandmodal">
  		<div class="modal-dialog ">
      		<div class="modal-content">
      			...
      			<div class="modal-footer">
      				 <button type="button" class="btn btn-success" id='submit' onclick="$('#brandmodal form').submit()">Save</button>
        			<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
      			</div>
      		</div>
      	</div>

<div class="bakground-color:blue;"><div class="col-lg-12" style="top:2cm;left:2cm;">
	<div class="row">
		<div class="card card-stats col-md-3 bg-success">
            <!-- Card body -->
            <div class="card-body">
              <div class="row">
                <div class="col">
      	...
      	<div class="ml-4 card card-stats col-md-3 bg-secondary">
            <!-- Card body -->
            <div class="card-body">
              <div class="row">
                <div class="col">
      	...
      	<div class="ml-4 card card-stats col-md-3 bg-primary">
            <!-- Card body -->
            <div class="card-body">
              <div class="row">
                <div class="col">
